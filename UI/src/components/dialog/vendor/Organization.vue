  ...
  <div class="Organziation">
    ...
    <div class="Detail-Info">
      <ul class="List">
        ...
        <li
          class="Element"
          @click="selectDetailForm(5)"
          :class="[index == 5 ? 'active' : '']"
        >
          Ghi chú
        </li>
      </ul>
      <Contact v-show="index == 1" />
      <Rule v-show="index == 2" />
      <BankAccount v-show="index == 3" />
      <Address v-show="index == 4" />
      <Note v-show="index == 5" />
    </div>
  </div>
</template>
